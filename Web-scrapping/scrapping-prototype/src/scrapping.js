...
const scrapeCarTwo = async(url) => {
    ...
    const [el] = await page.$x('/html/body/div[2]/div/div[4]/div[1]/div[2]/div/div[3]/div[3]/div[2]/div[2]/div[2]/div/div[2]/div/div/div[1]/div[1]/a/img')
    
    const src = await el.getProperty('src')
    const srcTxt = await src.jsonValue()


    const [el2] = await page.$x('/html/body/div[2]/div/div[4]/div[1]/div[2]/div/div[3]/div[3]/div[2]/div[2]/div[2]/div/div[2]/div/div/div[1]/div[2]/div[1]/h4/a')
    const name = await el2.getProperty('textContent')
    const nameText = await name.jsonValue()

    const [el3] = await page.$x('/html/body/div[2]/div/div[4]/div[1]/div[2]/div/div[3]/div[3]/div[2]/div[2]/div[2]/div/div[2]/div/div/div[1]/div[2]/ul/li[1]')
    const mileage = await el3.getProperty('textContent')
    const mileageText = await mileage.jsonValue()


    const [el4] = await page.$x('/html/body/div[2]/div/div[4]/div[1]/div[2]/div/div[3]/div[3]/div[2]/div[2]/div[2]/div/div[2]/div/div/div[1]/div[2]/ul/li[2]')
    const engineSize = await el4.getProperty('textContent')
    const engineSizeText = await engineSize.jsonValue()

    const [el5] = await page.$x('/html/body/div[2]/div/div[4]/div[1]/div[2]/div/div[3]/div[3]/div[2]/div[2]/div[2]/div/div[2]/div/div/div[1]/div[2]/ul/li[3]')
    const transimssion = await el5.getProperty('textContent')
    const transimssionText = await transimssion.jsonValue()

    const [el6] = await page.$x('/html/body/div[2]/div/div[4]/div[1]/div[2]/div/div[3]/div[3]/div[2]/div[2]/div[2]/div/div[2]/div/div/div[1]/div[2]/ul/li[4]')
    const fuelType = await el6.getProperty('textContent')
    const fuelTypeText = await fuelType.jsonValue()

    const [el7] = await page.$x('/html/body/div[2]/div/div[4]/div[1]/div[2]/div/div[3]/div[3]/div[2]/div[2]/div[2]/div/div[2]/div/div/div[1]/div[2]/div[2]/div/span/span/strong')
    const price = await el7.getProperty('textContent')
    const priceText = await price.jsonValue()


    const [el8] = await page.$x('/html/body/div[2]/div/div[4]/div[1]/div[2]/div/div[3]/div[3]/div[2]/div[2]/div[2]/div/div[2]/div/div/div[1]/div[2]/span')
    const location = await el8.getProperty('textContent')
    const locationText = await location.jsonValue()


    const [el9] = await page.$x('/html/body/div[2]/div/div[4]/div[1]/div[2]/div/div[3]/div[3]/div[2]/div[2]/div[2]/div/div[2]/div/div/div[2]/div[1]/div/a')
    const number = await el9.getProperty('textContent')
    const numberText = await number.jsonValue()

    const car2 = {srcTxt,nameText,mileageText,engineSizeText,transimssionText,fuelTypeText,priceText,locationText,numberText}
